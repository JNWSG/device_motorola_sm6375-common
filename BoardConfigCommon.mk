...
TARGET_RECOVERY_WIPE := $(COMMON_PATH)/rootdir/etc/recovery.wipe
...
ifneq ($(filter userdebug eng,$(TARGET_BUILD_VARIANT)),)
  ifneq ($(wildcard external/avb/test/data/testkey_rsa2048.pem),)
...
else ifeq (user,$(TARGET_BUILD_VARIANT))
  ifneq (,$(wildcard vendor/yaap/signing/keys/releasekey.key))
